        ...
        <div className="space-y-8 z-10">
          <div className="reveal opacity-0 translate-y-10 transition-all duration-700 delay-100">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight tracking-tighter uppercase">
              WE BUILD <span className="chrome-text">SYSTEMS</span> THAT <span className="text-accent">SCALE</span> BUSINESSES.
            </h1>
            <p className="mt-6 text-xl text-text-secondary max-w-lg leading-relaxed font-body">
              Scaling Businesses with AI + Automation. From 949 leads in 60 days to 70,000 prospects moved to pipeline — see how we deliver measurable ROI.
            </p>
          </div>

          <div className="reveal opacity-0 translate-y-10 transition-all duration-700 delay-300 flex flex-wrap gap-4">
            <Button variant="primary" glow className="px-8 py-4 text-lg">
